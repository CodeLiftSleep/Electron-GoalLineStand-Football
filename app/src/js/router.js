        ...
        .service('dataService', ['$timeout', '$q', function($timeout, $q) {
            ...
            this.getData = function() {
                ...
                $timeout(function() {
                    ...
                    var filebuffer = fs.readFileSync('app/assets/data/Football.sqlite');
        ...
        .config(['$stateProvider', '$urlRouterProvider',
            function($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state('Start', {
                        url: '/start',
                        templateUrl: '../html/Start/new_game.html',
                    ...
                    .state('Start.career', {
                        ...
                        templateUrl: '../html/Start/Start-career.html',
                    ...
                    .state('Start.career2', {
                        ...
                        templateUrl: '../html/Start/Start-career2.html',
                    ...
                    .state('Start.career3', {
                        ...
                        templateUrl: '../html/Start/Start-career3.html',
                    ...
                    .state('Start.teamSelect', {
                        ...
                        templateUrl: '../html/Start/Start-teamSelect.html',
                    ...
                    .state('Start.single', {
                        parent: 'Start',
                        url: '/single',
                        templateUrl: '../html/Start/Start-single.html'
                    })

                    .state('Start.quick', {
                        parent: 'Start',
                        url: '/quick',
                        templateUrl: '../html/Start/Start-quick.html'
                    })

                    .state('Start.situation', {
                        parent: 'Start',
                        url: '/situation',
                        templateUrl: '../html/Start/Start-situation.html'
                    })
